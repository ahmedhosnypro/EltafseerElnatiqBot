...
public class StopMessageLiveLocation extends BotApiMethod<Serializable> {
   ...
   public static StopMessageLiveLocation.StopMessageLiveLocationBuilder builder() {
      return new StopMessageLiveLocation.StopMessageLiveLocationBuilder();
   }

   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof StopMessageLiveLocation)) {
         return false;
      } else {
         StopMessageLiveLocation other = (StopMessageLiveLocation)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof StopMessageLiveLocation;
   }
   ...
   public String toString() {
      return "StopMessageLiveLocation(chatId=" + this.getChatId() + ", messageId=" + this.getMessageId() + ", inlineMessageId=" + this.getInlineMessageId() + ", replyMarkup=" + this.getReplyMarkup() + ")";
   }

   public StopMessageLiveLocation() {
   }

   public StopMessageLiveLocation(String chatId, Integer messageId, String inlineMessageId, InlineKeyboardMarkup replyMarkup) {
      this.chatId = chatId;
      this.messageId = messageId;
      this.inlineMessageId = inlineMessageId;
      this.replyMarkup = replyMarkup;
   ...
   public static class StopMessageLiveLocationBuilder {
      ...
      @JsonProperty("chat_id")
      public StopMessageLiveLocation.StopMessageLiveLocationBuilder chatId(String chatId) {
         this.chatId = chatId;
         return this;
      }

      @JsonProperty("message_id")
      public StopMessageLiveLocation.StopMessageLiveLocationBuilder messageId(Integer messageId) {
         this.messageId = messageId;
         return this;
      }

      @JsonProperty("inline_message_id")
      public StopMessageLiveLocation.StopMessageLiveLocationBuilder inlineMessageId(String inlineMessageId) {
         this.inlineMessageId = inlineMessageId;
         return this;
      }

      @JsonProperty("reply_markup")
      public StopMessageLiveLocation.StopMessageLiveLocationBuilder replyMarkup(InlineKeyboardMarkup replyMarkup) {
         this.replyMarkup = replyMarkup;
         return this;
      }
      ...
      public String toString() {
         return "StopMessageLiveLocation.StopMessageLiveLocationBuilder(chatId=" + this.chatId + ", messageId=" + this.messageId + ", inlineMessageId=" + this.inlineMessageId + ", replyMarkup=" + this.replyMarkup + ")";
      }
   }
}
